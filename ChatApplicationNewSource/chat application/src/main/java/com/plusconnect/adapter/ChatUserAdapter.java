...
//        }
        ...
        if (!TextUtils.isEmpty(chatUserBean.isMsgSentToServerFromUserAcknl())
            ...
            holder.tickIndicator1.setText(tick);
            holder.tickIndicator2.setVisibility(View.GONE);
            holder.tickIndicator1.setTextColor(activity.getResources().getColor(R.color.text_startup_page));
            holder.tickIndicator2.setTextColor(activity.getResources().getColor(R.color.text_startup_page));
        }

        if (!TextUtils.isEmpty(chatUserBean.isMsgSentToServerFromUserAcknl())
                &&chatUserBean.isMsgSentToUserFromServerAcknl().equals(chatTrue)){
            holder.tickIndicator1.setText(tick);
            holder.tickIndicator2.setText(tick);
            holder.tickIndicator2.setVisibility(View.VISIBLE);
            holder.tickIndicator1.setTextColor(activity.getResources().getColor(R.color.text_startup_page));
            holder.tickIndicator2.setTextColor(activity.getResources().getColor(R.color.text_startup_page));
        }

        if (!TextUtils.isEmpty(chatUserBean.isMsgSentToServerFromUserAcknl())
                &&chatUserBean.isMsgReadAcknlByClient().equals(chatFalse)){
            holder.tickIndicator1.setText(tick);
            holder.tickIndicator2.setText(tick);
            holder.tickIndicator2.setVisibility(View.VISIBLE);
            holder.tickIndicator1.setTextColor(activity.getResources().getColor(R.color.textTickColor));
            holder.tickIndicator2.setTextColor(activity.getResources().getColor(R.color.textTickColor));
    ...
    private View.OnClickListener onClickListener=new View.OnClickListener() {
        ...
        public void onClick(View v) {
            String sallonId= (String) v.getTag();
    ...
    public class ChatUserViewHolder extends RecyclerView.ViewHolder{
        ...
        public View view;
        public RoundedImageView chat_list_profile_image;
        ...
        public ChatUserViewHolder(View itemView) {
            super(itemView);
            view=itemView;
            chat_list_profile_image= (RoundedImageView) view.findViewById(R.id.chat_list_profile_image);
            ...
            tickIndicator1= (FontAwesomeTextView) view.findViewById(R.id.tickIndicator1);
            tickIndicator2= (FontAwesomeTextView) view.findViewById(R.id.tickIndicator2);
